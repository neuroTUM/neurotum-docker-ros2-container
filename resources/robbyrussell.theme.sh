...
function _omb_theme_PROMPT_COMMAND() {
    ...
    local scm_info; scm_info=$(scm_prompt_info)

    local first_line="${_omb_prompt_bold_teal}(🐳 Dev-Container)${_omb_prompt_reset_color} ${python_venv}${base_directory}${scm_info:+ $scm_info}"
